            ...
            experiences = [
                {
                  ...
                  "companyName": "Apollo Education Group",
                  "mentorName": "Bhavesh Patel",
                  "mentorContact": "NA",
                  "companyLogo": {
                    "url": "http://www.apollo.edu/",
                    "logoname": "Apollo",
                    "filenameOnServer": "apollo-logo.png"
                  },
                  "technologies": [
                  ...
                  "workDescription": [
                    "Created an ETL pipeline to process students and course data generated by Blackboard using Python and AWS Glue which involved use of microservices, DynamoDB, S3 and RedShift.",
                    "Created data pipeline using AWS Athena for data generated by Blackboard in AWS S3. Leveraged partitioning in AWS Athena which reduced the data retrieval time significantly. Used Airflow for scheduling jobs."
                  ]
                },
                {
